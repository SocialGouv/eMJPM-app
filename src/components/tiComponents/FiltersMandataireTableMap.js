...
import { changeTypeOfMandatairesFilters } from "../../actions";
...
const FiltersMandataireTableMap = ({ display,changeTypeOfMandatairesFilters }: FiltersMandataireTableMapType) => {
  return (
...
export default connect(null, mapDispatchToProps)(FiltersMandataireTableMap);
